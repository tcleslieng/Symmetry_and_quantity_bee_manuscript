...
symgraph <- ggplot(symdframe, aes(x = condition, y = proportion, fill = condition)) +
  ...
  labs(x = "Condition", y = "Mean proportion of correct choices", fill = "Condition") +
...
# Extract AIC
aic_models1 <- AIC(symtrlm2)
aic_models2 <- AIC(symtrlm3)

# Compare AIC values
print(c(AIC_Model1 = aic_models1, AIC_Model2 = aic_models2))
...
# Extract AIC
aic_modela1 <- AIC(asymtrlm2)
aic_modela2 <- AIC(asymtrlm3)

# Compare AIC values
print(c(AIC_Model1 = aic_modela1, AIC_Model2 = aic_modela2))
```

### *Bootstrapping to check models*

```{r, eval=FALSE}

# Bootstrap for model1
bootstrap_model1 <- bootMer(symtrlm2, FUN = fixef, nsim = 1000)

# Bootstrap for model2
bootstrap_model2 <- bootMer(symtrlm3, FUN = fixef, nsim = 1000)

# Compare bootstrap distributions
print(c(Median_Coefficient_Model1 = median(bootstrap_model1$t), Median_Coefficient_Model2 = median(bootstrap_model2$t)))
